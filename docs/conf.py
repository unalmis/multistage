...
author = "Kaya Unalmis"
version = multistage.__version__
release = version
...
top_level = "multistage"
linkcode_blob = "head"
linkcode_url = r"https://github.com/unalmis/multistage"
...
latex_elements = {
    ...
    \begin{titlepage}
        ...
        \centering
        \textbf{\Huge {multistage Documentation}}
